...
<% } %>
  ...
  <!-- SQL query to retrieve products in the Women category -->
  <sql:query var="products" dataSource="${dbConnection}">
    SELECT * FROM product WHERE category_name = "Women";
  </sql:query>
  
  <!-- Loop over the retrieved products and generate cards for each one -->
