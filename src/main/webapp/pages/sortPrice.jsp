...
<% } %>
  ...
  <div class="wrapper">
      ...
      <!-- Create a section for displaying product cards -->
<div class="card-grid">
      
  <!-- Connect to the database using taglib directive -->
  <sql:setDataSource var="dbConnection" driver="com.mysql.jdbc.Driver"
      url="jdbc:mysql://localhost:3306/e-commerce" user="root"
      password="" />
  
  <!-- Retrieve all products from the database, sorted by price -->
  <sql:query var="products" dataSource="${dbConnection}">
      SELECT * FROM product ORDER BY CAST(unit_price AS DECIMAL(10,2)) ASC;
  </sql:query>
