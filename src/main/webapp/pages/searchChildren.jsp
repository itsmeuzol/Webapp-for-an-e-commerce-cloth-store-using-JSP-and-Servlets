      ...
      <div class="card-grid">
      	...
      	<!-- Database Connection using taglib directive -->
				<sql:setDataSource var="dbConnection" driver="com.mysql.jdbc.Driver"
					...
					password="" />
        <!-- Query the database for products in the Children category -->
				<sql:query var="products" dataSource="${dbConnection}">
          	SELECT  * FROM product WHERE category_name = "Children";
          </sql:query>
          <!-- Iterate over the products obtained from the query -->
